...
rear_strut_bottom_dx = d / 2 - material_thickness - strut_width - 2;
rear_strut_bottom_dy = 5;
rear_strut_top_dx = d / 2 - material_thickness - strut_width * 3;
rear_strut_top_dy = 5;
rear_strut_max_angle = 135;
...
front_strut_bottom_dx = d / 2 - material_thickness - strut_width * 3.5;
front_strut_bottom_dy = 5;
front_strut_top_dx = -(d / 2 - material_thickness - strut_width);
front_strut_top_dy = 5;
