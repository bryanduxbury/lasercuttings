...
handle_width = 3 * 5;
handle_corner_radius = 1 * 5;
handle_thickness = 1.5 * 5;
fridge_handle_height = 12 * 5;
freezer_handle_height = 6 * 5;
fridge_x_from_right = 2 * 5;
fridge_y_from_top = 0;

// fridge dimensions
fridge_total_height = 3 * 12 * 5;
fridge_width = 18 * 5;

fridge_freezer_height = 12 * 5;
...
stove_door_gutter = 2 * 5;
stove_door_window_corner_radius = 1 * 5;
...
// microwave
microwave_height = 8 * 5;
microwave_width = 36 * 5;
microwave_depth = 8 * 5;

microwave_window_gutter = 2 * 5;
microwave_handle_depth = 3 * 5;


cupboard_width = 16 * 5;

control_panel_width = 4 * 5;
